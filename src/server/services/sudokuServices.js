...
var SudokuService = /** @class */ (function () {
    ...
    SudokuService.prototype.getNewBoard = function (playedGamesIDs) {
        if (playedGamesIDs === void 0) { playedGamesIDs = null; }
        ...
        var notPlayedGamesList = gamesList.filter(function (game) { return !playedGamesIDs.some(function (id) { return id === game.id; }); });
    ...
    SudokuService.prototype.checkSolution = function (game) {
        var solution = this._getGame(game.id).solution;
    ...
    SudokuService.prototype._getGame = function (id) {
        var game = gamesList.find(function (game) { return game.id === id; });
        if (game) {
            return game;
        }
        throw new Error();
